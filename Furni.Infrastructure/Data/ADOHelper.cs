...
namespace Furni.Helper
{
    ...
    public class ADOHelper : IDisposable
	{
		...
		/// </summary>
		public static string ConnectionString { get { return ConfigurationManager.ConnectionStrings["shope_and_dropConnectionString"].ConnectionString; } }
		...
		public SqlCommand CreateCommand(string qry, CommandType type, params object[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				else throw new ArgumentException(ShopAndDrop.Resource.Resource.InvalidNumberOrType);
			}
			return cmd;
		}
